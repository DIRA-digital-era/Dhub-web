...
const ListingDetailsScreen: React.FC<Props> = ({ route }) => {
  ...
  // GLM: Updated to fetch fee dynamically from pricing_configs
...
const getStyles = (colors: any, isDark: boolean) => StyleSheet.create({
  ...
  statusActive: {
    backgroundColor: isDark ? '#1A3A1A' : '#e6f4ea',
    borderWidth: 1,
    borderColor: colors.primary,
  },
  statusInactive: {
    backgroundColor: isDark ? '#3A1A1A' : '#fce8e6',
    borderWidth: 1,
  ...
  shareCtaCard: {
    ...
    alignItems: 'center',
    justifyContent: 'space-between',
    backgroundColor: isDark ? '#2D2510' : '#F5E7C8',
    padding: 16,
    borderRadius: 12,
    marginVertical: 12,
    borderWidth: 1,
