    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.activityList}>
        {notifications.length === 0 ? (
          <Text style={styles.loadingText}>No recent activity</Text>
        ) : (
          notifications.map((notif) => (
            ...
            >
              ...
              <View style={styles.activityContent}>
                <Text style={styles.activityMessage}>{notif.title}</Text>
...
const styles = StyleSheet.create({
  ...
  loadingText: { color: '#999', textAlign: 'center', marginVertical: 20 },
  ...
  activityMessage: { color: '#FFFFFF', fontSize: 14, fontWeight: '500', marginBottom: 4 },
