...
const styles = StyleSheet.create({
  ...
  card: { flex: 1, minWidth: '45%', backgroundColor: '#2A2A2A', padding: 16, borderRadius: 12, alignItems: 'center' },
  iconContainer: { width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center', marginBottom: 8 },
  value: { color: '#fff', fontSize: 20, fontWeight: 'bold', marginBottom: 4 },
  label: { color: '#999', fontSize: 12, fontWeight: '500', textAlign: 'center' },
});
